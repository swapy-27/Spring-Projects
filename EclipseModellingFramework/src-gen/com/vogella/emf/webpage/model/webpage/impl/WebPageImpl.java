...
public class WebPageImpl extends MinimalEObjectImpl.Container implements WebPage {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebpagePackage.WEB_PAGE__DESCRIPTION, oldDescription,
					description));
	}
	...
	public EList<Category> getCategory() {
		if (category == null) {
			category = new EObjectContainmentEList<Category>(Category.class, this, WebpagePackage.WEB_PAGE__CATEGORY);
		}
		return category;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case WebpagePackage.WEB_PAGE__CATEGORY:
